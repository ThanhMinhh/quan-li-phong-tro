                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-center">
                      <img
                        src={`https://img.vietqr.io/image/970422-686815102004-compact2.png?amount=${hoaDon.tongTien}&addInfo=Thanh%20toan%20${hoaDon.maHoaDon}&accountName=VU%20THANH%20MINH`}
                        alt="VietQR Code"
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-2">
                      ...
                      <div className="text-sm">
                        ...
                        <div className="font-semibold font-mono">686815102004</div>
                      </div>
                      <div className="text-sm">
                        <div className="text-gray-600">Chủ tài khoản</div>
                        <div className="font-semibold">VU THANH MINH</div>
                      </div>
                      <div className="text-sm">
